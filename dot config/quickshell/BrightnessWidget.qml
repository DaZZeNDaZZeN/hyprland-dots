...
Item {
    ...
    Rectangle {
        ...
        height: 28
        radius: 14
        color: brightnessButtonMouseArea.containsMouse ? brightnessControl.palette.surface_container_high : brightnessControl.palette.surface_container
        border.color: brightnessPopup.visible ? brightnessControl.palette.primary : (brightnessButtonMouseArea.containsMouse ? brightnessControl.palette.on_surface : brightnessControl.palette.secondary)
        ...
        Row {
            ...
            Image {
                ...
                source: {
                    ...
                    let hoverColor = encodeURIComponent(brightnessControl.palette.on_surface);
            ...
            Text {
                ...
                color: brightnessControl.palette.on_surface
                font.pixelSize: 11
                font.bold: true
            ...
            ColumnLayout {
                ...
                Slider {
                    ...
                    handle: Rectangle {
                        ...
                        implicitHeight: 14
                        radius: 7
                        color: brightnessSlider.pressed ? brightnessControl.palette.on_surface : brightnessControl.palette.primary
                        border.color: brightnessControl.palette.primary
